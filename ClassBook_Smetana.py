...
# Спершу зроби свою гілку, в ній створи екземпляри класу, а вже потім пуш її на гітхаб, так як казав викладач
class Book:
...
print(user_1.get_book_info(), user_1.get_age_of_book())